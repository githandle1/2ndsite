...
const FIELD_FILTERED_GENRES = new Set(["still-life", "landscape", "portrait", "ukiyo-e"]);
...
export function rankMetItems(items, genreId = "", keyword = "") {
  ...
  const eligible = FIELD_FILTERED_GENRES.has(genreId)
    ? scored.filter((entry) => entry.genreScore > 0)
    : scored;
